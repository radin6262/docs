...
Its recemmeded to install the latest builds.
...
```
If you want a gui for the server just delete the --nogui parameter
...
If your not so interested in using terminals and manual editing or your getting confused
    - You can use the many tools that are out there to setup the server with some good ui
    - You can use buy a server from the hosting platforms
...
Still not enough or any ideas send us using github
